...
| Kotlin | `kotlin/main.kt` | `kotlinc main.kt -include-runtime -d main.jar && java -jar main.jar` |
...
| Assembly | `asm/main.asm` | `nasm -f elf64 main.asm -o main.o && ld main.o -o main && ./main` |
